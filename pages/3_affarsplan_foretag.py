...
# Konfigurera sidan
st.set_page_config(
    page_title="3. Företagsbeskrivning - Jimotec AB", layout="wide"
)
...
with col1:
    st.link_button(
        ...
        "https://docs.google.com/document/d/1D6PyXga8MefqTN508VR7gjMYzXZ6nDLz/edit",
    )

st.write("")  # Lite avstånd innan dokumentet

# --- INBÄDDAT GOOGLE DOCS-DOKUMENT ---
doc_url = "https://docs.google.com/document/d/1D6PyXga8MefqTN508VR7gjMYzXZ6nDLz/preview"
