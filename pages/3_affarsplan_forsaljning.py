...
# Konfigurera sidan
st.set_page_config(
    page_title="5. Marknadsföring och försäljning - Jimotec AB", layout="wide"
)
...
with col1:
    st.link_button(
        ...
        "https://docs.google.com/document/d/1th48Ii1O8MjGrxdAfh1bWH0OAKEPjJfn/edit",
    )

st.write("")  # Lite avstånd innan dokumentet

# --- INBÄDDAT GOOGLE DOCS-DOKUMENT ---
doc_url = "https://docs.google.com/document/d/1th48Ii1O8MjGrxdAfh1bWH0OAKEPjJfn/preview"
