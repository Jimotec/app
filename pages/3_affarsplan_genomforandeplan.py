...
# Konfigurera sidan
st.set_page_config(page_title="Genomförandeplan och milstolpar - Jimotec AB", layout="wide")
...
with col1:
    st.link_button(
        ...
        "https://docs.google.com/document/d/1yLAaf1Z675NHGwLZUCQbGrOG3_KA7OvxQ2JSTCaIrvg/edit",
    )

st.write("")  # Lite avstånd innan dokumentet

# --- INBÄDDAT GOOGLE DOCS-DOKUMENT ---
doc_url = "https://docs.google.com/document/d/1yLAaf1Z675NHGwLZUCQbGrOG3_KA7OvxQ2JSTCaIrvg/preview"
