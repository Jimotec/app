...
# Konfigurera sidan
st.set_page_config(page_title="2. Affärsidé och vision - Jimotec AB", layout="wide")
...
with col1:
    st.link_button(
        ...
        "https://docs.google.com/document/d/1-lfD5Ay9W4rHqbLJnVtadcRv5X5lpwju/edit",
    )

st.write("")  # Lite avstånd innan dokumentet

# --- INBÄDDAT GOOGLE DOCS-DOKUMENT ---
doc_url = "https://docs.google.com/document/d/1-lfD5Ay9W4rHqbLJnVtadcRv5X5lpwju/preview"
