...
# Konfigurera sidan
st.set_page_config(page_title="4. Marknad och bransch - Jimotec AB", layout="wide")
...
with col1:
    st.link_button(
        ...
        "https://docs.google.com/document/d/1VQXvDQJFhtOkQ34davAo-VsuDsNlqmTz/edit",
    )

st.write("")  # Lite avstånd innan dokumentet

# --- INBÄDDAT GOOGLE DOCS-DOKUMENT ---
doc_url = "https://docs.google.com/document/d/1VQXvDQJFhtOkQ34davAo-VsuDsNlqmTz/preview"
