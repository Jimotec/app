...
# Konfigurera sidan
st.set_page_config(
    page_title="6. Organisation och personal - Jimotec AB", layout="wide"
)
...
with col1:
    st.link_button(
        ...
        "https://docs.google.com/document/d/1Oi3lnskq68dEj75W0u3mttjwrHbK1mdh/edit",
    )

st.write("")  # Lite avstånd innan dokumentet

# --- INBÄDDAT GOOGLE DOCS-DOKUMENT ---
doc_url = "https://docs.google.com/document/d/1Oi3lnskq68dEj75W0u3mttjwrHbK1mdh/preview"
