...
# Konfigurera sidan
st.set_page_config(
    page_title="7. Produkter eller tjänster - Jimotec AB", layout="wide"
)
...
with col1:
    st.link_button(
        ...
        "https://docs.google.com/document/d/1shgFeqwrRhCJXvcUm8uhAkd_BuOcWlBh/edit",
    )

st.write("")  # Lite avstånd innan dokumentet

# --- INBÄDDAT GOOGLE DOCS-DOKUMENT ---
doc_url = "https://docs.google.com/document/d/1shgFeqwrRhCJXvcUm8uhAkd_BuOcWlBh/preview"
