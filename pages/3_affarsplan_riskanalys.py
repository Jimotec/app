...
# Konfigurera sidan
st.set_page_config(page_title="Riskanalys och hantering - Jimotec AB", layout="wide")
...
with col1:
    st.link_button(
        ...
        "https://docs.google.com/document/d/12htoXlsD-eRJ0rh16-EnvQxEsqy-_hb6sPilh6Gf6LA/edit",
    )

st.write("")  # Lite avstånd innan dokumentet

# --- INBÄDDAT GOOGLE DOCS-DOKUMENT ---
doc_url = "https://docs.google.com/document/d/12htoXlsD-eRJ0rh16-EnvQxEsqy-_hb6sPilh6Gf6LA/preview"
